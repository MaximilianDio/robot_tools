...
Provides:
  ...
  - image_overlay:    composite 3D robot renders onto camera footage
...
from robot_video_tools.image_overlay import CalibrationPaths, calibrate_camera, image_overlay
